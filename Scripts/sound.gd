...
func play(file_path, decibel_diff, is_random_pitch : bool = false, random_pitch_range_amp : float = 0):
	...
	if is_random_pitch:
		var random_pitch = randf_range(1 - random_pitch_range_amp, 1 + random_pitch_range_amp)
